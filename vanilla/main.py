...
API_KEY = os.getenv("ASSEMBLYAI_API_KEY", "your_assemblyai_key_here")

if API_KEY == "your_assemblyai_key_here" or not API_KEY:
    print("Please set your ASSEMBLYAI_API_KEY in the .env file.")
    exit(1)
