  ...
  return (
    <div className="auth-page" style={{ minHeight: '100vh', background: '#ffffff', color: '#1a1a1a', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem' }}>
      <div className="glass-panel" style={{ background: '#ffffff', borderRadius: '24px', padding: '3.5rem', width: '100%', maxWidth: '480px', boxShadow: '0 20px 40px rgba(0,0,0,0.05)', border: '1px solid #eee' }}>
        ...
        <p style={{ color: '#666', textAlign: 'center', marginBottom: '2.5rem', fontSize: '1.05rem' }}>Start your journey with VoiceAgent.</p>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          <div>
            <label style={{ display: 'block', fontSize: '0.9rem', fontWeight: 600, color: '#4a4a4a', marginBottom: '0.6rem' }}>Name</label>
            <input
              type="text"
              required
              value={formData.name}
          ...
          <div>
            <label style={{ display: 'block', fontSize: '0.9rem', fontWeight: 600, color: '#4a4a4a', marginBottom: '0.6rem' }}>Email</label>
            <input
              type="email"
              required
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginTop: '0.5rem' }}>
             <input type="checkbox" required style={{ width: '18px', height: '18px', borderRadius: '4px', cursor: 'pointer' }} />
             <span style={{ fontSize: '0.9rem', color: '#666' }}>I agree to the Privacy Policy</span>
          </div>
        ...
        <p style={{ marginTop: '2.5rem', textAlign: 'center', color: '#666', fontSize: '0.95rem' }}>
          Already have an account? <Link href="/auth/signin" style={{ color: '#000', fontWeight: 700, textDecoration: 'none' }}>Sign In</Link>
        </p>
      </div>
    </div>
  );
